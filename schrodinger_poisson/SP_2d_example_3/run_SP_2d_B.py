...
if __name__=="__main__":
    ...
    def initial_conditions(x,t_ini,D_func,L,xi2):
        ...
        plt.savefig("initial_cond_B.png")
        return u_ini
    ...
    save_dir_case = save_dir+"_relaxed_In2"
    if not(os.path.exists(save_dir_case)):
            os.makedirs(save_dir_case)
    frm,tt,inv_change_dict,mass_l,mass_err_l,energy_err_l,energy_Fd_l = run_SP_2d_example_1(dt,[x,y],[xix,xiy],kppa,t_ini,T,imx,inv_list,u_ini,exact_soln_np=None,dx_soln_jx=None,\
